...
static const struct {
	...
	20,
	{
		...
		(void*)(uintptr_t)enclave_u_sgxprotectedfs_fwrite_node,
		(void*)(uintptr_t)enclave_u_sgxprotectedfs_fclose,
		(void*)(uintptr_t)enclave_u_sgxprotectedfs_fflush,
		(void*)(uintptr_t)enclave_u_sgxprotectedfs_remove,
		(void*)(uintptr_t)enclave_u_sgxprotectedfs_recovery_file_open,
		(void*)(uintptr_t)enclave_u_sgxprotectedfs_fwrite_recovery_node,
		(void*)(uintptr_t)enclave_u_sgxprotectedfs_do_file_recovery,
